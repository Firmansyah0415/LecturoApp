...
//        private const val DATABASE_VERSION = 2 // Increment version
...
//        private const val COLUMN_COMPLETED = "completed" // Tambah kolom ini
...
//            db.execSQL("ALTER TABLE $TABLE_SCHEDULES ADD COLUMN $COLUMN_COMPLETED INTEGER DEFAULT 0")
//        }
//    }
//
...
//            put(COLUMN_COMPLETED, if (schedule.completed) 1 else 0)
...
//                    completed = getInt(getColumnIndexOrThrow(COLUMN_COMPLETED)) == 1,
...
//    }
//
//    fun updateScheduleCompletedStatus(id: Long, completed: Boolean): Int {
//        val db = writableDatabase
//        val values = ContentValues().apply {
